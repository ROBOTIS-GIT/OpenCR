// MESSAGE FLASH_FW_SEND_BLOCK PACKING

#define MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK 154

typedef struct MAVLINK_PACKED __mavlink_flash_fw_send_block_t
{
 uint16_t addr; /*< */
...
/**
 * @brief Pack a flash_fw_send_block message
						       ...
						       uint8_t resp, uint16_t addr, uint8_t length, const uint8_t *data)
{
	...
	msg->msgid = MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_MIN_LEN, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_LEN, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_CRC);
}

/**
 * @brief Pack a flash_fw_send_block message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
						           ...
						           uint8_t resp,uint16_t addr,uint8_t length,const uint8_t *data)
{
	...
	msg->msgid = MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_MIN_LEN, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_LEN, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_CRC);
}

/**
 * @brief Encode a flash_fw_send_block struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param flash_fw_send_block C-struct to read the message contents from
 */
...
/**
 * @brief Encode a flash_fw_send_block struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
/**
 * @brief Send a flash_fw_send_block message
...
#if MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
...
// MESSAGE FLASH_FW_SEND_BLOCK UNPACKING


/**
 * @brief Get field resp from flash_fw_send_block message
 *
 * @return 0:No Resp, 1:Resp
 */
static inline uint8_t mavlink_msg_flash_fw_send_block_get_resp(const mavlink_message_t* msg)
{
 ...
 * @return 
 */
static inline uint16_t mavlink_msg_flash_fw_send_block_get_addr(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  0);
}

/**
 * @brief Get field length from flash_fw_send_block message
 *
 * @return 
 */
...
/**
 * @brief Get field data from flash_fw_send_block message
 *
 * @return 
 */
...
/**
 * @brief Decode a flash_fw_send_block message into a struct
 *
 * @param msg The message to decode
 * @param flash_fw_send_block C-struct to decode the message contents into
 */
static inline void mavlink_msg_flash_fw_send_block_decode(const mavlink_message_t* msg, mavlink_flash_fw_send_block_t* flash_fw_send_block)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_LEN? msg->len : MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_LEN;
        memset(flash_fw_send_block, 0, MAVLINK_MSG_ID_FLASH_FW_SEND_BLOCK_LEN);
	memcpy(flash_fw_send_block, _MAV_PAYLOAD(msg), len);
#endif
}
