...
static void mavlink_test_flash_fw_send_block(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_flash_fw_send_block_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_send_block_pack(system_id, component_id, &msg , packet1.resp , packet1.addr , packet1.length , packet1.data );
	mavlink_msg_flash_fw_send_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_send_block_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.resp , packet1.addr , packet1.length , packet1.data );
	mavlink_msg_flash_fw_send_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_flash_fw_send_block_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_send_block_send(MAVLINK_COMM_1 , packet1.resp , packet1.addr , packet1.length , packet1.data );
	mavlink_msg_flash_fw_send_block_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_flash_fw_verify(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_flash_fw_verify_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_verify_pack(system_id, component_id, &msg , packet1.resp , packet1.crc , packet1.param );
	mavlink_msg_flash_fw_verify_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_verify_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.resp , packet1.crc , packet1.param );
	mavlink_msg_flash_fw_verify_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_flash_fw_verify_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_verify_send(MAVLINK_COMM_1 , packet1.resp , packet1.crc , packet1.param );
	mavlink_msg_flash_fw_verify_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_flash_fw_req_block(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FLASH_FW_REQ_BLOCK >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_flash_fw_req_block_t packet_in = {
		963497464,17443,151
    };
	mavlink_flash_fw_req_block_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.addr = packet_in.addr;
        packet1.length = packet_in.length;
        packet1.resp = packet_in.resp;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_req_block_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_flash_fw_req_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_req_block_pack(system_id, component_id, &msg , packet1.resp , packet1.addr , packet1.length );
	mavlink_msg_flash_fw_req_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_req_block_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.resp , packet1.addr , packet1.length );
	mavlink_msg_flash_fw_req_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_flash_fw_req_block_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_req_block_send(MAVLINK_COMM_1 , packet1.resp , packet1.addr , packet1.length );
	mavlink_msg_flash_fw_req_block_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_flash_fw_read_block(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_flash_fw_read_block_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_read_block_pack(system_id, component_id, &msg , packet1.resp , packet1.addr , packet1.length , packet1.data );
	mavlink_msg_flash_fw_read_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_read_block_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.resp , packet1.addr , packet1.length , packet1.data );
	mavlink_msg_flash_fw_read_block_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_flash_fw_read_block_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_flash_fw_read_block_send(MAVLINK_COMM_1 , packet1.resp , packet1.addr , packet1.length , packet1.data );
	mavlink_msg_flash_fw_read_block_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_opencr_msg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_flash_fw_req_block(system_id, component_id, last_msg);
