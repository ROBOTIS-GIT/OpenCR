...
#define MAVLINK_MSG_ID_FLASH_FW_ERASE_LEN 9
#define MAVLINK_MSG_ID_FLASH_FW_ERASE_MIN_LEN 9
#define MAVLINK_MSG_ID_156_LEN 9
#define MAVLINK_MSG_ID_156_MIN_LEN 9

#define MAVLINK_MSG_ID_FLASH_FW_ERASE_CRC 28
#define MAVLINK_MSG_ID_156_CRC 28
...
#define MAVLINK_MESSAGE_INFO_FLASH_FW_ERASE { \
	...
	"FLASH_FW_ERASE", \
	2, \
	{  { "resp", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_flash_fw_erase_t, resp) }, \
         { "param", NULL, MAVLINK_TYPE_UINT8_T, 8, 1, offsetof(mavlink_flash_fw_erase_t, param) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_FLASH_FW_ERASE { \
...
{
	return mavlink_msg_flash_fw_erase_pack(system_id, component_id, msg, flash_fw_erase->resp, flash_fw_erase->param);
}
...
{
	return mavlink_msg_flash_fw_erase_pack_chan(system_id, component_id, chan, msg, flash_fw_erase->resp, flash_fw_erase->param);
}
...
static inline void mavlink_msg_flash_fw_erase_send(mavlink_channel_t chan, uint8_t resp, const uint8_t *param)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_FLASH_FW_ERASE_LEN];
	_mav_put_uint8_t(buf, 0, resp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_flash_fw_erase_send(chan, flash_fw_erase->resp, flash_fw_erase->param);
#else
 ...
 */
static inline void mavlink_msg_flash_fw_erase_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t resp, const uint8_t *param)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
