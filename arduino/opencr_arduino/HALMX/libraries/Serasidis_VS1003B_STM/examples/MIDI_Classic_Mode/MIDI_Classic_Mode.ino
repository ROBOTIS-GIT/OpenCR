...
VS1003 player(PB12, PB10, PA8, PB11,spi2); // cs_pin, dcs_pin, dreq_pin, reset_pin, use SPI 2
...
void setup () {
    ...
    Serial1.begin(19200);   // initiate a serial port at 19200 bits per second
    delay(100);
    Serial1.println("-= VS1053B MIDI file player =-");
    Serial1.println("(c) 20 August 2015 by Vassilis Serasidis");
    Serial1.println("email: avrsite@yahoo.gr");
    ...
    player.printDetails();  // Print the VS1003 / VS1053 registers information
}
