...
/*
Manipulator::Manipulator(String name, int8_t dof, int8_t number_of_joint, int8_t number_of_link, int8_t number_of_tool)
{
  name_ = name;
  dof_ = dof;
...
void Manipulator::Load(Joint* joint, Link* link, Tool* tool)
{
...
Joint::~Joint(){}
void Joint::Init(String name, int8_t number, int8_t dxl_id)
{
    name_ = name;
    number_ = number;
    dxl_id_ = dxl_id;
...
Link::~Link(){}
void Link::Init(String name, int8_t number_of_joint_in_link)
{
    name_ = name;
    number_of_joint_in_link_ = number_of_joint_in_link;
    JointInLink jointinlink[number_of_joint_in_link];
}
void Link::Init(String name, int8_t number_of_joint_in_link, float mass, Eigen::Vector3f center_position)
{
    name_ = name;
    number_of_joint_in_link_ = number_of_joint_in_link;
    mass_ = mass;
...
JointInLink::~JointInLink(){}
void JointInLink::Init(int8_t number, Eigen::Vector3f relative_position, Eigen::Matrix3f relative_orientation)
{
    number_=number;
    relative_position_ = relative_position;
    relative_orientation_ = relative_orientation;
}
void JointInLink::Init(int8_t number, Eigen::Vector3f relative_position, Eigen::Vector3f axis)
{
    number_=number;
    relative_position_ = relative_position;
    relative_orientation_;
}
void JointInLink::Init(int8_t number, Eigen::Vector3f relative_position, Eigen::Matrix3f relative_rotation_matrix, Eigen::Vector3f axis)
{
    number_=number;
    relative_position_ = relative_position;
}
...
Tool::~Tool(){}
void Tool::Init(String tool_type, int8_t number, Eigen::Vector3f position_from_final_joint, Eigen::Matrix3f orientation_from_final_joint)
{
